...
public class UnionBySizeCompressingDisjointSetsTests extends BaseTest {
    ...
    void test() {
        ...
        int temp = disjointSets.findSet("Hello");
        System.out.println("temp: " + temp);
        disjointSets.union("world", "!");
        System.out.println(disjointSets.findSet("Hello"));
        System.out.println(disjointSets.findSet("world"));
        System.out.println(disjointSets.findSet("!"));
